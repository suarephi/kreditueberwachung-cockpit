...
UI: dict[str, dict[str, str]] = {
    "de": {
        ...
        # Inbox
        "inbox_title":           "Meine Vorgänge",
        "inbox_subtitle":        "Alle Cases und Events, die Dir aktuell zugewiesen sind.",
        "inbox_kpi_open":        "Offene Vorgänge",
        "inbox_kpi_overdue":     "SLA überfällig",
        "inbox_kpi_24h":         "Fällig in 24h",
        "inbox_kpi_critical":    "Kritisch / Hoch",
        "inbox_section_events":  "Events",
        "inbox_section_cases":   "Fälle",
        "inbox_no_events":       "Keine offenen Events.",
        "inbox_no_cases":        "Keine offenen Fälle.",
        # Mahnwesen
        "dunning_section":       "Mahnwesen · aktive Stufen",
        "dunning_section_sub":   "Stufen 1 (Mahnung) bis 4 (Verwertung) je Kredit",
        "dunning_th_step":       "Stufe",
        "dunning_th_issued":     "Versendet",
        "dunning_th_due":        "Frist",
        "dunning_th_overdue":    "Rückstand (CHF)",
        "dunning_th_fee":        "Gebühr",
        "dunning_th_status":     "Status",
        "dunning_th_loan":       "Kredit",
        "dunning_no_active":     "Aktuell kein offenes Mahnwesen.",
        "dunning_dossier_label": "Mahnwesen · Stufenübersicht",
        # Reverse Stresstest
        "rs_section":            "Reverse Stresstest · Headroom pro Kredit",
        "rs_section_sub":        "Wieviel ΔMarktwert oder ΔEinkommen verträgt der Kredit, bevor LTV 80 % oder DSTI 33 % gerissen wird?",
        "rs_kpi_lt5":            "< 5 % Headroom",
        "rs_kpi_5_10":           "5-10 %",
        "rs_kpi_10_20":          "10-20 %",
        "rs_kpi_20_30":          "20-30 %",
        "rs_kpi_gt30":           "> 30 %",
        "rs_card_top":           "Top 50 fragilste Kredite (kleinster Marktwert-Headroom)",
        "rs_th_propdrop":        "Marktwert-Drop bis LTV 80 %",
        "rs_th_incomedrop":      "Einkommens-Drop bis DSTI 33 %",
        "rs_th_ltv_pp":          "ΔLTV-Pp bis 80",
        "rs_th_dsti_pp":         "ΔDSTI-Pp bis 33",
        # IFRS-9
        "ifrs_section":          "IFRS-9-Staging",
        "ifrs_section_sub":      "Stage 1 = Performing · Stage 2 = SICR (Significant Increase in Credit Risk) · Stage 3 = Credit-Impaired",
        "ifrs_kpi_s1":           "Stage 1 (Performing)",
        "ifrs_kpi_s2":           "Stage 2 (SICR)",
        "ifrs_kpi_s3":           "Stage 3 (Default)",
        "ifrs_kpi_lifetime_el":  "Lifetime ECL gesamt",
        "ifrs_th_stage":         "Stage",
        "ifrs_th_reason":        "SICR-Auslöser",
        "ifrs_th_lifetime_el":   "Lifetime EL",
        "ifrs_card_stage2":      "Stage 2 · Top 50 SICR-Fälle nach Lifetime EL",
        "ifrs_card_stage3":      "Stage 3 · Top 50 Default-Fälle nach Lifetime EL",
    },
    "en": {
        ...
        "inbox_title":           "My queue",
        "inbox_subtitle":        "All cases and events currently assigned to you.",
        "inbox_kpi_open":        "Open items",
        "inbox_kpi_overdue":     "SLA overdue",
        "inbox_kpi_24h":         "Due in 24h",
        "inbox_kpi_critical":    "Critical / High",
        "inbox_section_events":  "Events",
        "inbox_section_cases":   "Cases",
        "inbox_no_events":       "No open events.",
        "inbox_no_cases":        "No open cases.",
        "dunning_section":       "Dunning · active steps",
        "dunning_section_sub":   "Stages 1 (1st reminder) to 4 (foreclosure) per loan",
        "dunning_th_step":       "Step",
        "dunning_th_issued":     "Issued",
        "dunning_th_due":        "Due",
        "dunning_th_overdue":    "Overdue (CHF)",
        "dunning_th_fee":        "Fee",
        "dunning_th_status":     "Status",
        "dunning_th_loan":       "Loan",
        "dunning_no_active":     "No active dunning steps.",
        "dunning_dossier_label": "Dunning · step history",
        "rs_section":            "Reverse stress test · headroom per loan",
        "rs_section_sub":        "How far can market value or income drop before LTV 80 % or DSTI 33 % is breached?",
        "rs_kpi_lt5":            "< 5 % headroom",
        "rs_kpi_5_10":           "5-10 %",
        "rs_kpi_10_20":          "10-20 %",
        "rs_kpi_20_30":          "20-30 %",
        "rs_kpi_gt30":           "> 30 %",
        "rs_card_top":           "Top 50 most fragile loans (smallest property headroom)",
        "rs_th_propdrop":        "Property drop until LTV 80 %",
        "rs_th_incomedrop":      "Income drop until DSTI 33 %",
        "rs_th_ltv_pp":          "ΔLTV pp to 80",
        "rs_th_dsti_pp":         "ΔDSTI pp to 33",
        "ifrs_section":          "IFRS-9 staging",
        "ifrs_section_sub":      "Stage 1 = performing · Stage 2 = SICR (Significant Increase in Credit Risk) · Stage 3 = credit-impaired",
        "ifrs_kpi_s1":           "Stage 1 (Performing)",
        "ifrs_kpi_s2":           "Stage 2 (SICR)",
        "ifrs_kpi_s3":           "Stage 3 (Default)",
        "ifrs_kpi_lifetime_el":  "Total lifetime ECL",
        "ifrs_th_stage":         "Stage",
        "ifrs_th_reason":        "SICR trigger",
        "ifrs_th_lifetime_el":   "Lifetime EL",
        "ifrs_card_stage2":      "Stage 2 · top 50 SICR cases by lifetime EL",
        "ifrs_card_stage3":      "Stage 3 · top 50 default cases by lifetime EL",
    },
}
